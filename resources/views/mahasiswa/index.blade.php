				...
				<div class="bg-gradient-secondary shadow-secondary border-radius-lg pt-4 pb-3 container">
					<div class="row">
						...
						<div class="col-sm-4 text-end">
							<a class="text-warning-outline pe-4 hide" href="{{ route('mahasiswa.create') }}">
			...
			<div class="card-body px-0 pb-2 mx-3">
				<div class="table-responsive p-0">
					<table id="tblMahasiswa" class="table align-items-center justify-content-center mb-0">
						<thead>
							<tr>
								<th class="text-uppercase text-center text-secondary text-xs font-weight-bolder opacity-7 px-2">{{ __('Jenis KKN') }}</th>
								<th class="text-uppercase text-center text-secondary text-xs font-weight-bolder opacity-7 px-2">{{ __('Prodi') }}</th>
								<th class="text-uppercase text-center text-secondary text-xs font-weight-bolder opacity-7 px-2">{{ __('NIM') }}</th>
						...
						<tbody>
							...
							<tr>
								<td class="text-xs">{{ $mhs->jenis_kkn }}</td>
