        ...
        <div class="col-12 col-xl-4">
          <div class="card card-plain h-100">
            ...
            <div class="card-body p-3">
              <h6 class="text-uppercase text-body text-xs font-weight-bolder">Kelompok</h6>
              <ul class="list-group">
              ...
              <h6 class="text-uppercase text-body text-xs font-weight-bolder mt-4">Lokus KKN</h6>
              <ul class="list-group">
                <li class="list-group-item border-0 px-0">
                  <div class="form-check form-switch ps-0">
