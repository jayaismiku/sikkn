  ...
  <div class="card card-body mx-3 mx-md-4 mt-n6">
    <div class="row gx-4 mb-2">
      ...
      <div class="col-auto my-auto">
        <div class="h-100">
          <h5 class="mb-1">{{ $panitia->nama_lengkap }}</h5>
          <p class="mb-0 font-weight-normal text-sm">{{ __('NIM: ') }} {{ $panitia->nim }}</p>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="row">
        ...
        <div class="col-12 col-xl-4">
          <div class="card card-plain h-100">
            <div class="card-header pb-0 p-3">
              <div class="row">
                ...
                <div class="col-md-4 text-end">
                  <a href="{{ route('panitia.edit', $panitia->panitia_id) }}">
            ...
            <div class="card-body p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">{{ __('Username: ') }}</strong> {{ $panitia->username }}</li>
                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">{{ __('Email: ') }}</strong> {{ $panitia->email }}</li>
                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">{{ __('Telp (WA): ') }}</strong> {{ $panitia->telp }}</li>
                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">{{ __('Fakultas: ') }}</strong> {{ $panitia->fakultas }}</li>
                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">{{ __('Program Studi: ') }}</strong> {{ $panitia->prodi }}</li>
