        ...
        <div class="table-responsive p-0">
          <table class="table align-items-center justify-content-center mb-0">
            ...
            <tbody>
              ...
              <tr>
                <td class="text-xs">{{ date('d M Y', strtotime($lap->tanggal_kegiatan)) }}</td>
                <td class="text-xs nama">{{ $lap->nama_kegiatan }}</td>
                <td class="text-xs deskripsi">{!! $lap->deskripsi_kegiatan !!}</td>
                ...
                <td class="text-xs text-center">
                  <a class="text-warning" href="{{ route('laporan.tervalidasi', $lap->laporan_id)}}"><span class="material-icons">edit</span></a>
                </td>
              </tr>
              @endforeach
            </tbody>
